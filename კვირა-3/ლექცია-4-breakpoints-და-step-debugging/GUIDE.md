...
გაიდის დასრულების შემდეგ გაიარეთ დავალება, სადაც იმავე 5 ტექნიკას **ახალ პროექტზე** გამოიყენებთ:

- **დავალების ინსტრუქცია:** [`დავალება/README.md`](დავალება/README.md)
- **პროექტი:** [`დავალება/homework-breakpoints/`](დავალება/homework-breakpoints/) — Split the Bill, 5 ბაგი, `// BUG #N` კომენტარების გარეშე
